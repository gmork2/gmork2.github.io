        ...
        init: function(options) {
            ...
            var defaults = {
                ...
                'tinyConfig': {
                    ...
                    formats : {
						bulletlist: {classes: 'list-unordered'}
					},
                    style_formats: [
						{title: "Headers", items: [
						...
						{title: "Bootstrap", items: [
							{title: "Text muted",  format: "p", classes: 'muted'},
							{title: "Text warning",  format: "p", classes: 'text-warning'},
							{title: "Text error",  format: "p", classes: 'text-error'},
							{title: "Text info", format: "p", classes: 'text-info'},
							{title: "Text success", format: "p", classes: 'text-success'},
							{title: 'Pull right', inline: 'span', classes: 'pull-right'},
							{title: 'Pull left', inline: 'span', classes: 'pull-left'}
						]},
						{title: "Orange", items: [
							{title: "Unordened list", format: "div", inline: 'ul', classes: 'list-unordered'},
							{title: "Ordened list",  format: "ol", classes: 'list-ordered'},
							{title: "Checkmark list",  format: "ul", classes: 'list-checkmark'},
							{title: "Arrow list",  format: "ol", classes: 'list-arrow'}
						]}
